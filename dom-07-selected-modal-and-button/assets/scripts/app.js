...
function deleteMovieHandler(movieId) {
    ...
    toggleBackdrop();
  cancelDeletionBtn =  deleteMovieModal.querySelector('.btn--passive');
...
newMovieElement.clasName = 'movie-element';
...
toggleBackdrop();
clearMovieInputs();
renderNewMovieElement(newMovie.id, newMovie.title, newMovie.image,
     newMovie.rating)
updateUI();
}
